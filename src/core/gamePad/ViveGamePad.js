...
export class ViveController extends GamePad {
    constructor(hand) {
        ...
        if (hand === CONST.LEFT) {
            this.buttons = [Buttons.viveLeftTrackpad, Buttons.viveLeftTrigger];
        } else {
            this.buttons = [Buttons.viveRightTrackpad, Buttons.viveRightTrigger];
        }
...
messenger.on(CONST.RODIN_STARTED, () => {
