...
export class GamePad extends EventEmitter {
    ...
    updateObject() {
        ...
        if (pose.position !== null) this.sculpt.globalPosition.fromArray(pose.position);
        if (pose.orientation !== null) this.sculpt.globalQuaternion.fromArray(pose.orientation);
